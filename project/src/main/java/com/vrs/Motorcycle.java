...
public class Motorcycle extends Vehicle {
    public Motorcycle(String make, String model, int year, double mpg, String color, String engine) {
    ...
    public static String[] read() {
        ...
        try {
            ...
            FileReader reader = new FileReader("Motorcycle.txt");
    ...
    public static int isFile() {
        File file = new File("Motorcycle.txt");try {
            if (file.createNewFile()) {
                System.out.println("File Motorcycle.txt created");
            } else {
    ...
    public void addData() {
        isFile();
        try {
            FileWriter myWriter = new FileWriter("Motorcycle.txt");
    ...
    public static void rentV(String vehi) {
        GUI.moveVehicle("Motorcycle.txt","RMotorcycle.txt",vehi);
    }

    public static void returnV(String vehi) {
        GUI.moveVehicle("RMotorcycle.txt","Motorcycle.txt",vehi);
    }
