...
public class Sedan extends Vehicle {
    public int numSeats;
    public Sedan (String make, String model, int year, double mpg, String color, String engine, int seats)
    {
    ...
    public static String[] read() {
        ...
        try {
            ...
            FileReader reader = new FileReader("Sedan.txt");
    ...
    public static int isFile() {
        File file = new File("Sedan.txt");try {
            if (file.createNewFile()) {
                System.out.println("File Sedan.txt created");
            } else {
    ...
    public void addData() {
        isFile();
        try {
            FileWriter myWriter = new FileWriter("Sedan.txt");
    ...
    public static void rentV(String vehi) {
        GUI.moveVehicle("Sedan.txt","RSedan.txt",vehi);
    }

    public static void returnV(String vehi) {
        GUI.moveVehicle("RSedan.txt","Sedan.txt",vehi);
    }
}
